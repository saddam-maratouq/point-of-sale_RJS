         ...
         <div className="about-sec wrapper ">
            ...
            <div className="container">
                <div className="row  align-items-center  row-2">
                    ...
                    <h2 className='Desc-Title-2' > We make everything by hand with the best possible ingredients.  </h2>
                       <p  className='lorem-2' >  Lorem ipsum dolor sit amet consectetur adipisicing elit. Reprehenderit quas
                        sint quibusdam? Nulla odio alias consequuntur, doloribus inventore nesciunt cumque. 
                        </p> 
